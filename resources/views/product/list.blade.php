...
<main>
   <section id="banner-cate">
      <div class="avarta">
      <img data-src="{{ isset($cateno) ? $cateno->imagehome : $banners[0]->image}}" class="img-fluid lazyloaded" width="100%" alt="{{$title}}" src="{{ isset($cateno) ? $cateno->imagehome : $banners[0]->image}}">
      </div>
   </section>
   <section id="service">
      <div class="container">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              <div class="item">
                                    ...
                                    <div class="info">
                                    <p>
                                      <a style="color:~color: var(--theme-para);" href="{{route('detailProduct',['cate'=>$item->cate_slug,'slug'=>$item->slug])}}"><strong>{{languageName($item->name)}}</strong></a>
                                    </p>
